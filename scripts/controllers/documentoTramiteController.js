...
.controller('Crear2DocumentoTramiteCtrl', ['$scope', 'DocumentoTramite', 'Documento','$route','$routeParams', 'toastr', '$location',
function ($scope, DocumentoTramite,Documento, $route,$routeParams,toastr,$location)
{
  $scope.ajustes = {
    menu:{
      titulo: 'Gestión de tramites de Carné Sanitario',
